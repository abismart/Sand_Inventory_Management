...
<div class="container-fluid side-nav">
  ...
  <div class="col-3" >
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <a class="nav-link active" id="v-pills-home-tab" href="index.php" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fa fa-plus-square" aria-hidden="true"></i> Create New Project</a>
  ...
  <div class="col-9" >
    <div class="tab-content" id="v-pills-tabContent">
      <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
      	<h4 class="text-center"><b>Create New Project and add record</b></h4>
          	<div class="frm">
    			<form class="form-row" name="addform" method="post" action="addrecord.php">
    				
    				<div class="col-md-6">
    				<input required="" name="customer_name" id="addr" type="text" >
    				<label placeholder="Customer Name"></label>
    				</div>
