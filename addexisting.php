...
<div class="container-fluid side-nav">
  ...
  <div class="col-3" >
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link active" id="v-pills-profile-tab"  href="existingprojects.php" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Go Back</a>
      <a class="nav-link" id="v-pills-messages-tab" href="customerreport.php" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fa fa-users" aria-hidden="true"></i> Customer Report</a>
  ...
  <div class="col-9" >
    <div class="tab-content" id="v-pills-tabContent">
      ...
      <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
        <h4 class="text-center"><b>Create records - Select project to add new records</b></h4>
                <div class="frm">
          <form class="form-row" name="addform" method="post" action="addrecord.php">
            
            <div class="col-md-6">
            <input required="" name="customer_name" id="addr" value='<?php echo $_GET["customer_name"] ?>' type="text" readonly>
            <label placeholder="Customer Name" style="-webkit-transform: translate(0, -1.5em) scale(0.9, 0.9);"></label>
            </div>

            <div class="col-md-6">
            <input type="date" name="date" id="date" required="">
            <label placeholder="Date"></label>
            </div>

            <div class="col-md-6">
            <input type="text" name="vehicle_no" id="adddes" required="">
            <label placeholder="Vehicle Number"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="bill_no" id="addn" type="number" >
            <label placeholder="Bill Number"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="material" id="addr" type="text" >
            <label placeholder="Material"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="unit" id="addt" type="text">
            <label placeholder="Unit"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="rate" id="addc" type="number">
            <label placeholder="Rate"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="location_no" id="addesr" type="text" >
            <label placeholder="Location Number"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="amount_paid_for_customer" id="adds"  type="number">
            <label placeholder="Total Amount Paid for customer"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="driver_name" id="addf"  type="text">
            <label placeholder="Driver Name"></label>
            </div>

            <div class="col-md-6">
            <input required="" name="amount_paid_for_driver" id="adds"  type="number">
            <label placeholder="Total Amount Paid for Driver"></label>
            </div>

            <div class="col-md-12">
            <button type="submit" style="width:inherit;font-weight:bolder;" class="btn btn-primary"><i class="fa fa-plus-square"></i> CREATE RECORD</button>
            </div>
          </form>
        </div>
      </div>
...
function myff(){
    toastr["error"]("Error in adding record!, please try again","Error");
}
function rcheck() {
