...
<div class="container-fluid side-nav">
  ...
  <div class="col-3" >
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link active" id="v-pills-profile-tab"  href="existingprojects.php" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fa fa-plus" aria-hidden="true"></i> Add To Existing Project</a>
...
if (mysqli_num_rows($result) > 0) {
    while($row = mysqli_fetch_assoc($result)) {
        echo "<div class='col-sm-6 col-lg-3 text-center' style='padding: 20px;'>
             <a href='addexisting.php?customer_name=".$row["customer_name"]."' style='color:white;font-weight:bold;text-decoration:none;'>
